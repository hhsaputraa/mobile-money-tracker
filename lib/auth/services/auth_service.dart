...
class AuthService {
  ...
  /// Delegasi ke UserManagementService untuk menjaga kompatibilitas terbalik
  Future<List<UserModel>> fetchUsersList() async {
    return UserManagementService().fetchUsersList();
  }
  ...
  Future<AuthResult> adminCreateUser({
    ...
    return UserManagementService().adminCreateUser(
      email: email,
      password: password,
      fullName: fullName,
      isAdmin: isAdmin,
